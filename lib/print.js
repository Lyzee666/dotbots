...
┃╭┈─────────────
┃╰────➤ ↶↷
┃ ુོ THIS BOT: ${chalk.cyan('%s')}
┃ ુོ TIME: ${chalk.yellow('%s')} 
┃ ુོ SIZE: ${chalk.yellow('%s [%s %sB]')}
┃╭┈─────────────
┃╰────➤ ↶↷
┃ ુོ   ${chalk.red('%s')}
┃ ુོ SENDER: ${chalk.green('%s')} 
┃ ુོ DATABASE USERS: ${chalk.cyan('%s%s')} 
┃ ુོ   ${chalk.yellow('ID: ')}${chalk.green('%s')} 
┃ ુོ MESSAGE TYPE: ${chalk.cyan('%s')}
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
MESSAGE:\n`.trim(),
    me + ' ~' + conn.user.name,
